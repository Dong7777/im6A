...
#    print(freq_dict) #对应kmer词典编号：计数  {2: 3, 48: 3, 60: 2, 31: 1, 7: 3, 1: 6, 16: 3, 4: 4, 32: 3, 56: 3, 14: 3, 51: 2, 12: 1, 35: 2, 40: 2, 10: 1, 34: 2, 8: 2, 0: 6, 17: 2, 20: 2, 21: 2, 5: 3, 44: 2, 43: 2, 42: 2, 58: 2, 63: 2, 47: 3, 27: 1, 54: 2, 29: 2, 30: 1, 23: 1, 62: 2, 15: 1, 26: 1, 61: 1, 11: 2, 24: 1, 6: 1, 33: 1, 50: 1, 28: 2, 55: 1, 39: 1, 57: 1, 19: 1, 49: 1}
    return freq_dict


def coden(seq,kmer,tris):
    coden_dict = tris #kmer序号编码
    freq_dict = frequency(seq,kmer,coden_dict)
    vectors = np.zeros((41, len(coden_dict.keys())))
...
tris4 = get_4_trids()
protein = 'h_b_Test.fa'
indataX = dealwithdata(protein)
np.save('indataX.npy',indataX)
